...
-- Generate highlight groups for Nvim-cmp. Existing attributes will NOT be overwritten
function Color.gen_cmpkind_hl()
  ...
  local data = {
    ...
    Codeium = colors.green,
    TabNine = colors.green,
    SuperMaven = colors.green,
  }
  for kind, color in pairs(data) do
    set_global_hl("CmpItemKind" .. kind, colors.base, color)
  end
end
