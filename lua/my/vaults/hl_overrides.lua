...
local getExtraHl = function(mocha)
  local colorschemeUtils = require "my.helpers.colors"
  ...
  return vim.tbl_deep_extend("force", result, {
    ...
    -- nvim-cmp
    CmpItemKindSnippet = { bg = mocha.mauve, fg = mocha.base},
    CmpItemKindKeyword = { bg = mocha.red, fg = mocha.base},
    CmpItemKindText = { bg = mocha.teal, fg = mocha.base},
    CmpItemKindMethod = { bg = mocha.blue, fg = mocha.base},
    CmpItemKindConstructor = { bg = mocha.blue, fg = mocha.base},
    CmpItemKindFunction = { bg = mocha.blue, fg = mocha.base},
    CmpItemKindFolder = { bg = mocha.blue, fg = mocha.base},
    CmpItemKindModule = { bg = mocha.blue, fg = mocha.base},
    CmpItemKindConstant = { bg = mocha.peach, fg = mocha.base},
    CmpItemKindField = { bg = mocha.green, fg = mocha.base},
    CmpItemKindProperty = { bg = mocha.green, fg = mocha.base},
    ...
    CmpItemKindVariable = { bg = mocha.flamingo, fg = mocha.base},
    CmpItemKindFile = { bg = mocha.blue, fg = mocha.base},
    ...
    CmpItemKindValue = { bg = mocha.peach, fg = mocha.base},
